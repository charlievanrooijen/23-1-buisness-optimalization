...
function loadCharts() {
  addChart(buisness_stats[0][2], buisness_stats, "#B82E2E");
};
...
function addChart(title, data, color) {
  ...
  elem.setAttribute("style", "display: inline-block; width: 500px; height: 500px; padding: 20px;");
  elem.id = 'dataChart';
